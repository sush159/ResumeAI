...
export default function App() {
  ...
  const startNewScreening = () => {
    setStep("jd"); setJdData({ text: "", analysis: null }); setScreeningResults(null);
    setCurrentSessionId(null); setPage("screening");
  };
...
const globalStyles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  :root {
    --bg: #070c18; --surface: #0d1525; --surface2: #121c30; --surface3: #1a2640;
    --border: #1e2d45; --border2: #253550;
    --accent: #3b7df8; --accent-hover: #2563eb; --accent-muted: rgba(59,125,248,0.1);
    --text: #e2e8f4; --text2: #8896b0; --text3: #4e607a;
    --success: #22c55e; --success-muted: rgba(34,197,94,0.08);
    --warning: #eab308; --warning-muted: rgba(234,179,8,0.08);
    --danger: #ef4444;  --danger-muted: rgba(239,68,68,0.08);
    --sidebar-w: 256px;
  }
  ...
  .btn {
    ...
    gap: 8px; letter-spacing: -0.01em; white-space: nowrap;
  }
  ...
  input, textarea, select {
    ...
    font-size: 14px; padding: 10px 14px; outline: none; transition: border-color 0.15s; resize: vertical;
  }
  ...
  .spinner { width: 15px; height: 15px; border: 2px solid var(--border2); border-top-color: var(--accent); border-radius: 50%; animation: spin 0.7s linear infinite; flex-shrink: 0; }
  ...
  .modal { background: var(--surface); border: 1px solid var(--border2); border-radius: 14px; padding: 28px; width: 100%; max-width: 520px; }
`;
